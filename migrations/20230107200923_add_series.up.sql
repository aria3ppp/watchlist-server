...
call add_contribution_and_invalidation_columns(
	...
	p_column_contributed_by_fk_index_name => 'serieses_idx_contributed_by',
	
	p_column_contributed_at_name => 'contributed_at',
	p_column_contributed_at_type => 'TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP',
	p_column_contributed_at_column_index_name => 'serieses_idx_contributed_at',
...
CREATE INDEX IF NOT EXISTS serieses_idx_title ON serieses (title);
CREATE INDEX IF NOT EXISTS serieses_idx_descriptions ON serieses (descriptions);

-- create index on date_started and date_ended
CREATE INDEX IF NOT EXISTS serieses_idx_date_started ON serieses (date_started);
CREATE INDEX IF NOT EXISTS serieses_idx_date_ended ON serieses (date_ended);
