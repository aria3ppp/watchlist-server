...
type Watchfilm struct {
	...
	UserID      int       `boil:"user_id" json:"-" toml:"-" yaml:"-"`
	FilmID      int       `boil:"film_id" json:"-" toml:"-" yaml:"-"`
	TimeAdded   time.Time `boil:"time_added" json:"time_added" toml:"time_added" yaml:"time_added"`
	TimeWatched null.Time `boil:"time_watched" json:"time_watched,omitempty" toml:"time_watched" yaml:"time_watched,omitempty"`

	R *watchfilmR `boil:"-" json:"-" toml:"-" yaml:"-"`
	L watchfilmL  `boil:"-" json:"-" toml:"-" yaml:"-"`
}
